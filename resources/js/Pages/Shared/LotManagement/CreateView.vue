                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <button
                                ...
                                class="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-gray-300 dark:border-neutral-600 bg-white dark:bg-neutral-700 text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-neutral-600 transition"
                            >
                                <svg
                                    ...
                                    class="lucide lucide-map-pin-icon lucide-map-pin shrink-0"
                                >
                                    <path
