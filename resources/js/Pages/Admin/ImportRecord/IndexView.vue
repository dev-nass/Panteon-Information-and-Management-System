            ...
            >
                ...
                <div class="flex flex-wrap gap-x-4">
                    ...
                    <article>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Upload CSV or XLSX files to import burial and
                ...
                >
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex flex-col">
                            ...
                            >
                                Determines how the spreadsheet columns are
                                parsed
                            </span>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <template v-else> Select Import Type </template>
                ...
                <div>
                    ...
                    <div
                        ...
                        :class="[
                            'cursor-pointer p-8 sm:p-[4rem] flex justify-center bg-white/50 dark:bg-neutral-900/40 border border-dashed rounded-xl transition',
                            isDragging
                    ...
                    >
                        <div class="text-center flex flex-col items-center">
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                Supported formats: CSV, XLSX • Max size 2MB
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                >
                                    Import Errors ({{
                                        page.props.flash.importErrors.length
                                    }})
                                </p>
                                <div class="max-h-48 overflow-y-auto space-y-1">
                                    <p
                                        v-for="(error, index) in page.props
                                            .flash.importErrors"
                                        :key="index"
                ...
                <!-- Actions -->
                <div
                    class="flex flex-wrap gap-2 justify-between items-center pt-2"
                >
                    <Button data-hs-overlay="#import-logs-modal">
                        <span class="dark:text-white"> View Import Logs </span>
                    </Button>
