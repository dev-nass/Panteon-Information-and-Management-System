...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.redis.options.phase' => 'string',
            ...
            'filesystems.links./opt/lampp/htdocs/Projects2026/Panteon-Information-and-Management-System/public/storage' => 'string',
...
'hashing.argon.verify','hashing.rehash_on_login','view.paths','view.compiled','broadcasting.default',
...
'database.redis.client','database.redis.options.phase','database.redis.options.prefix','database.redis.options.persistent','database.redis.default.url',
...
'filesystems.disks.s3.report','filesystems.links./opt/lampp/htdocs/Projects2026/Panteon-Information-and-Management-System/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'dompdf.options.enable_remote','dompdf.options.allowed_remote_hosts','dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','debugbar.enabled',
...
'signed','throttle','verified','clerk',);
        registerArgumentsSet('routes', 
'debugbar.openhandler','debugbar.cache.delete','debugbar.queries.explain','debugbar.clockwork','debugbar.assets',
'boost.browser-logs','visitor.index','visitor.map.index','visitor.map.search',
'login','login.store','logout','register','register.store',
'api.map.burials','api.map.phases','api.map.partial.burials','api.map.cluster.burials','api.map.search',
'api.lot.management.phase','api.lot.management.cluster','api.lot.management.lot','api.lot.management.clusters','api.lot.management.lots',
'api.junctions','api.pathways','clerk.dashboard','clerk.generate_report.index','clerk.generate_report.generate',
'clerk.import.index','clerk.import.store','clerk.map.index','clerk.burial_records.index','clerk.burial_records.create',
'clerk.burial_records.store','clerk.burial_records.show','clerk.burial_records.update','clerk.burial_records.destroy','clerk.lot_management.index',
'clerk.lot_management.create','clerk.lot_management.store.phase','clerk.lot_management.store.cluster','clerk.lot_management.store.lot','clerk.lot_management.update.phase',
'clerk.lot_management.update.cluster','clerk.lot_management.update.lot','clerk.lot_management.delete.phase','clerk.lot_management.delete.cluster','clerk.lot_management.delete.lot',
'clerk.lot_management.show','storage.local',);
        registerArgumentsSet('views', 
'app','layout.reports','reports.burial','reports.deceased','reports.summary',
