                    ...
                    >
                                        ...
                                        <a class="block p-6" href="#">
                                            ...
                                            >
                                                ...
                                                <div class="grow">
                                                    ...
                                                    >
                                                    <span
                                                        class="block text-sm text-gray-500 dark:text-neutral-400"
                                    ...
                                    <td class="h-px w-72 min-w-72 align-top">
                                        <a class="block p-6" href="#">
                                            <div class="flex gap-x-1 mb-2">
                                                <svg
                                                    class="shrink-0 size-3 text-gray-800 dark:text-neutral-200"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    width="16"
                                                    height="16"
                                                    fill="currentColor"
                                            ...
                                            <span
                                                ...
                                                boyfriend, but then i found out
                                                he cheated on me so I kept it
                                                and I love it!! I wear it all
                                                the time and there is no problem
                                                with the fit even though its a
                                                mens" hat.</span
                                            >
                                        </a>
                                    </td>
                                ...
                                >
                                    ...
                                    >
                                        <a class="block p-6" href="#">
                                            ...
                                            >
                                                <span
                                                    class="inline-flex items-center justify-center size-9.5 rounded-full bg-gray-300 dark:bg-neutral-500"
                                                >
                                                    <span
                                    ...
                                    <td class="h-px w-72 min-w-72 align-top">
                                        <a class="block p-6" href="#">
                                            <div class="flex gap-x-1 mb-2">
                                                ...
                                                <svg
                                                    class="shrink-0 size-3 text-gray-400 dark:text-neutral-500"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    width="16"
                                                    height="16"
                                                    fill="currentColor"
                                            ...
                                            <span
                                                ...
                                                looks great and wears just as
                                                well. A great staple in ball
                                                caps.</span
                                            >
                                        </a>
                                    </td>
                                ...
                                >
                                    ...
                                    <td class="h-px w-72 min-w-72 align-top">
                                        <a class="block p-6" href="#">
                                            ...
                                            <span
                                                class="block text-sm font-semibold text-gray-800 dark:text-neutral-200"
                                                >Buy the product, you will not
                                                regret it!</span
                                            >
                                            <span
                                                class="block text-sm text-gray-500 dark:text-neutral-400"
                                                >Don't let this merchandise get
                                                away! It's a must buy and you
                                                will look good in it while
                                                working out.</span
                                            >
                                        </a>
                                    </td>
                                ...
                                >
                                    ...
                                    <td class="h-px w-72 min-w-72 align-top">
                                        <a class="block p-6" href="#">
                                            ...
                                            <span
                                                class="block text-sm font-semibold text-gray-800 dark:text-neutral-200"
                                                >Ready for the heat!</span
                                            >
                                            <span
                                                class="block text-sm text-gray-500 dark:text-neutral-400"
                                                >As good as the heat Rdy T-shirt
                                                but without the sleeves. Love
                                                the stripes on the back.</span
                                            >
                                        </a>
                                    </td>
                                    <td
                        ...
                        >
                            <div class="max-w-sm space-y-3">
                                <select
                                    class="py-2 px-3 pe-9 block bg-white dark:bg-neutral-800 border-gray-200 dark:border-neutral-700 text-gray-800 dark:text-white rounded-lg text-sm focus:border-blue-700 dark:focus:border-blue-600 focus:ring-blue-700 dark:focus:ring-blue-600"
                                >
                                    <option>1</option>
                                    <option>2</option>
                                    <option>3</option>
