    ...
    >
        ...
        >
            ...
            <div class="flex items-center justify-between">
                <a
                    class="flex-none font-semibold text-xl text-gray-800 dark:text-neutral-200 focus:outline-hidden focus:opacity-80"
                    href="#"
                    aria-label="Brand"
                    >Brand</a
                >
            ...
            >
                ...
                >
                    ...
                    >
                        <a
                            class="p-2 flex items-center text-sm text-blue-600 dark:text-blue-500 focus:outline-hidden"
                            href="#"
                            aria-current="page"
                        >
                            <svg
                        ...
                        <!-- Button Group -->
                        <div
                            class="flex items-center justify-center gap-x-1.5 md:ps-2.5 md:ms-1.5 before:block before:absolute before:top-1/2 before:-start-px before:w-px before:h-4 before:bg-gray-200 dark:before:bg-neutral-700 before:-translate-y-1/2"
                        >
                            <a
                                class="p-2 w-full flex items-center text-sm text-gray-800 dark:text-neutral-200 hover:text-gray-500 dark:hover:text-neutral-400 focus:outline-hidden focus:text-gray-500 dark:focus:text-neutral-400"
                                href="#"
                            >
                                <svg
