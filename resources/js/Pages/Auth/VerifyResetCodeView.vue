                ...
                <form @submit.prevent="handleSubmit" class="space-y-6">
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            class="tracking-[0.5em] text-center text-lg"
                            required
                            autofocus
                        />
                        <p
                    ...
                    >
                        ...
                        <button
                            ...
                            @click="handleResend"
                            :disabled="form.processing"
                            class="text-green-600 dark:text-green-500 hover:underline font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            Resend
                        </button>
                    </div>
