        ...
        <div class="flex flex-col">
            ...
            >
                ...
                >
                    ...
                    <div class="sm:col-span-2 lg:grow">
                        <div
                            class="flex flex-wrap justify-start lg:justify-end gap-x-2"
                        >
                            <div
                            ...
                            >
                                <Button
                                    ...
                                    aria-label="Dropdown"
                                >
                                    <span class="dark:text-white"> Type </span>
                                    ...
                                    >
                                        ...
                                        >
                                            <input
                                                ...
                                                :checked="
                                                    !filters.disposal ||
                                                    filters.disposal === 'all'
                                                "
                                                @change="
                                                    applyDisposalFilter('all')
                                                "
                                            />
                                            <span
                                                class="ms-3 text-sm text-gray-800 dark:text-neutral-200"
                            ...
                            <div>
                                <Link
                                    :href="
                                        route(roleRoutes[userRole].route_map)
                                    "
