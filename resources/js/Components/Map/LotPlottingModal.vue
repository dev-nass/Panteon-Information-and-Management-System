...
import { useCreatePlotLot } from '@/composables/lot_management/useCreatePlotLot';
            ...
            <div class="flex flex-col bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-700 shadow-lg rounded-xl">
                ...
                <div class="p-4">
                    <div class="mb-3 text-sm text-gray-600 dark:text-gray-400">
                        <p>📍 Click the marker tool and place it on the map to set the lot location.</p>
                    </div>
                    
                    <!-- Map Container -->
                    <div id="lot-plotting-map" class="w-full h-[500px] rounded-lg border border-gray-300 dark:border-neutral-600"></div>

                    <div v-if="coordinates" class="mt-3 text-sm text-green-600 dark:text-green-400">
                        ✓ Coordinates set: {{ coordinates.coordinates[1].toFixed(6) }}, {{ coordinates.coordinates[0].toFixed(6) }}
                    </div>
                </div>
