                    ...
                    >
                        ...
                        >
                            <template v-for="link in links" :key="link.id">
                                <a
                                    :href="`#${link.id}`"
                                    class="p-2 flex items-center text-sm font-medium rounded-lg transition-colors focus:outline-hidden"
                                    :class="{
                                        'text-green-600 dark:text-green-400  border-green-600':
                                            activeSection === link.id,
                                        'text-gray-700 dark:text-neutral-200 hover:text-gray-900 dark:hover:text-white hover:bg-white/30 dark:hover:bg-white/10':
                                            activeSection !== link.id,
                                    }"
                                >
                                    {{ link.label }}
