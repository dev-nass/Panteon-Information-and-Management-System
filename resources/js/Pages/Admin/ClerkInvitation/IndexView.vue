...
const back = () => {
    router.visit(route("admin.clerk_invitations.create"));
};
...
<template>
    <div class="max-w-340 px-4 py-10 sm:px-6 lg:px-8 lg:py-6 mx-auto">
        ...
        <div class="flex flex-col">
            ...
            >
                <div
                    class="px-6 py-4 flex flex-wrap items-center gap-3 border-b border-gray-200 dark:border-neutral-700"
                >
                    <Input
                        class="flex-1 min-w-0 max-w-xs md:max-w-md"
