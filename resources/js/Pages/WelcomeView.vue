...
<template>
    <div class="relative min-h-screen">
        ...
        <div class="relative h-screen -mt-20">
            ...
            >
                <div
                    class="border border-red-500 text-center text-white px-6 mt-20 flex flex-col justify-between gap-y-50 md:flex-col-reverse"
                >
                    <h1 class="text-5xl md:text-7xl font-bold mb-6">
                        Panteon De Dasmariñas
                    </h1>
                    <article class="md:flex md:flex-col-reverse">
                        ...
                        <p
                            class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto md:text-left md:mx-0"
                        >
                            A historic ground dedicated to honoring lives,
                            preserving heritage, and serving families with
                            compassion.
                        </p>
                    </article>
                </div>
