    ...
    <div class="relative flex flex-col h-full max-h-full">
        ...
        <div class="mb-5 px-2 flex flex-col gap-y-5">
            ...
            <ul class="flex flex-col gap-y-0.5">
                ...
                <li v-if="user.role === 'admin'">
                    <SidebarLink
                        :href="route('admin.user_management.index')"
                        :isActive="
                            page.component === 'Admin/UserManagement/IndexView'
                        "
                    >
                        <template v-slot:icon>
                            <span
                        ...
                        <template v-slot:text> User Management </template>
                    </SidebarLink>
                </li>
                ...
                <li v-if="user.role === 'admin'">
                    <SidebarLink
                        ...
                        :isActive="
                            page.component === 'Admin/ActivityLog/IndexView'
                        "
                    >
                        <template v-slot:icon>
                            <span
                        ...
                        <template v-slot:text> Activity Log </template>
                    </SidebarLink>
                </li>
