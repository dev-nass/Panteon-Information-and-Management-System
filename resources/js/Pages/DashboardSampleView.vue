...
<template>
    <div
        id="hs-pro-sidebar"
        class="hs-overlay [--auto-close:md] hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform w-65 hs-overlay-minified:w-13 overflow-hidden hidden fixed inset-y-0 z-60 start-0 bg-white dark:bg-neutral-800 border-e border-gray-200 dark:border-neutral-700 md:block md:translate-x-0 md:end-auto md:bottom-0"
        role="dialog"
        tabindex="-1"
        aria-label="Sidebar"
    >
        <div class="relative flex flex-col h-full max-h-full">
            <!-- Header -->
            <header
                class="py-2.5 px-4 flex justify-between items-center gap-x-2"
            >
                <div class="-ms-2 flex items-center gap-x-1">
                    <div class="md:hs-overlay-minified:hidden">
                        <a
                            class="shrink-0 inline-flex justify-center items-center size-9 rounded-lg text-xl inline-block font-semibold hover:bg-gray-100 dark:hover:bg-neutral-700 focus:outline-hidden focus:bg-gray-100 dark:focus:bg-neutral-700"
                            href="@@href"
                            aria-label="Preline"
                        >
                            <svg
                    ...
                    >
                        <svg
                            class="hidden hs-overlay-minified:block shrink-0 size-4"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                        ...
                        <svg
                            class="hs-overlay-minified:hidden shrink-0 size-4"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                    ...
                    <div
                        class="hidden sm:block md:hs-overlay-minified:hidden"
                    ></div>
                </div>
            ...
            >
                <div class="flex flex-col">
                    <span
                        class="block ps-2.5 mb-2 text-sm text-gray-400 dark:text-neutral-500"
                    >
                        Recent imports
                    </span>
                    ...
                    <ul class="flex flex-col gap-y-0.5">
                        <li>
                            <div class="relative group">
                                <a
                                    class="w-full flex items-center gap-x-2 py-2 ps-2.5 pe-8 text-sm text-gray-800 dark:text-neutral-200 truncate rounded-lg hover:bg-gray-100/70 dark:hover:bg-neutral-700/70 focus:outline-hidden focus:bg-gray-100/70 dark:focus:bg-neutral-700/70"
                                    href="chat-details.html"
                                >
                                    <span class="truncate"
                                        >Preline UI Overview</span
                                    >
                                </a>

                                <div
                                    class="absolute top-1/2 end-0 z-1 -translate-y-1/2 group-hover:opacity-100 opacity-0 transition-opacity duration-300"
                                >
                                    <!-- More Dropdown -->
                                    <div
                                        class="hs-dropdown [--scope:window] relative inline-flex"
                                    >
                                        <button
                                            id="hs-pro-chthmdid1"
                                            type="button"
                                        ...
                                        <!-- More Dropdown -->
                                        <div
                                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-32 transition-[opacity,margin] duration opacity-0 hidden z-60 bg-white dark:bg-neutral-900 border border-transparent rounded-xl shadow-lg before:absolute before:-top-4 before:start-0 before:w-full before:h-5"
                                            role="menu"
                                            aria-orientation="vertical"
                                            aria-labelledby="hs-pro-chthmdid1"
                                        >
        ...
        >
            ...
            >
                ...
                <div class="flex items-center sm:gap-x-1.5 truncate">
                    ...
                    <span
                        class="truncate font-medium text-sm sm:text-base text-gray-800 dark:text-neutral-200"
                    >
                        Preline UI Overview
                    </span>

                    <a
                        class="flex justify-center items-center gap-x-1.5 py-2 px-2.5 text-sm whitespace-nowrap text-blue-600 dark:text-blue-500 rounded-lg hover:bg-blue-700/10 dark:hover:bg-blue-600/10 focus:outline-hidden focus:bg-blue-700/10 dark:focus:bg-blue-600/10 disabled:opacity-50 disabled:pointer-events-none"
                        href="#"
                    >
                        <svg
                            class="shrink-0 size-4"
                ...
                <div class="flex items-center sm:gap-x-1.5">
                    <!-- More Dropdown -->
                    <div
                        class="hs-dropdown [--strategy:absolute] [--placement:bottom-right] relative inline-flex"
                    >
                        <button
                            id="hs-pro-ainmd"
                            type="button"
                        ...
                        <!-- More Dropdown -->
                        <div
                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-32 transition-[opacity,margin] duration opacity-0 hidden z-11 bg-white dark:bg-neutral-900 border border-transparent rounded-xl shadow-lg before:absolute before:-top-4 before:start-0 before:w-full before:h-5"
                            role="menu"
                            aria-orientation="vertical"
                            aria-labelledby="hs-pro-ainmd"
                        >
                            <div class="p-1 space-y-0.5">
                                <button
                                    type="button"
                    ...
                    >
                        ...
                        <!-- Language Dropdown -->
                        <div
                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-40 transition-[opacity,margin] duration opacity-0 hidden z-11 bg-white dark:bg-neutral-900 border border-transparent rounded-xl shadow-lg before:absolute before:-top-4 before:start-0 before:w-full before:h-5"
                            role="menu"
                            aria-orientation="vertical"
                    ...
                    >
                        <button
                            id="hs-dnad"
                            type="button"
                            class="p-0.5 inline-flex shrink-0 items-center gap-x-3 text-start text-sm text-gray-800 dark:text-neutral-200 rounded-full hover:bg-gray-100 dark:hover:bg-neutral-700 focus:outline-hidden focus:bg-gray-100 dark:focus:bg-neutral-700"
                            aria-haspopup="menu"
                            aria-expanded="false"
                            aria-label="Dropdown"
                        >
                        ...
                        <!-- Account Dropdown -->
                        <div
                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-60 transition-[opacity,margin] duration opacity-0 hidden z-20 bg-white dark:bg-neutral-900 border border-transparent rounded-xl shadow-xl"
                            role="menu"
                            aria-orientation="vertical"
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <span
                                        class="flex-1 cursor-pointer text-sm text-gray-800 dark:text-neutral-200"
                                        >Theme</span
                                    >
                                    <div
                                        class="p-0.5 inline-flex cursor-pointer bg-gray-100 dark:bg-neutral-700 rounded-full"
                                    >
                                        <button
                                            type="button"
                                            class="size-7 flex justify-center items-center bg-white dark:bg-neutral-800 shadow-sm text-gray-800 dark:text-white rounded-full hs-auto-mode-active:bg-transparent hs-auto-mode-active:shadow-none hs-dark-mode-active:bg-transparent hs-dark-mode-active:shadow-none"
                                        ...
                                        <button
                                            type="button"
                                            class="size-7 flex justify-center items-center text-gray-800 dark:text-white rounded-full hs-dark-mode-active:bg-gray-800 dark:hs-dark-mode-active:bg-neutral-100 hs-dark-mode-active:text-white dark:hs-dark-mode-active:text-neutral-800 hs-dark-mode-active:shadow-sm"
                                        ...
                                        <button
                                            type="button"
                                            class="size-7 flex justify-center items-center text-gray-800 dark:text-white rounded-full hs-auto-light-mode-active:bg-white dark:hs-auto-light-mode-active:bg-neutral-800 hs-auto-mode-active:shadow-sm"
