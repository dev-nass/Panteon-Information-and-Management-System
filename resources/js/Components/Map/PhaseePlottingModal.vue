...
import { useCreatePlotPhase } from '@/composables/lot_management/useCreatePlotPhase';
            ...
            <div class="flex flex-col bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-700 shadow-lg rounded-xl">
                ...
                <div class="p-4">
                    <div class="mb-3 text-sm text-gray-600 dark:text-gray-400">
                        <p>📐 Click the polygon tool and draw the phase boundary on the map.</p>
                    </div>
                    
                    <!-- Map Container -->
                    <div id="phase-plotting-map" class="w-full h-[500px] rounded-lg border border-gray-300 dark:border-neutral-600"></div>

                    <div v-if="coordinates" class="mt-3 text-sm text-green-600 dark:text-green-400">
                        ✓ Phase boundary set ({{ coordinates.coordinates[0].length - 1 }} points)
                    </div>
                </div>
